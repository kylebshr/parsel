  ...
  struct storyboard: Rswift.Validatable {
    ...
    struct main: StoryboardResourceWithInitialControllerType, Rswift.Validatable {
      ...
      func editViewController(_: Void) -> EditViewController? {
        return UIStoryboard(resource: self).instantiateViewController(editViewController)
      }
      
      static func validate() throws {
        if _R.storyboard.main().editViewController() == nil { throw ValidationError(description:"[R.swift] ViewController with identifier 'editViewController' could not be loaded from storyboard 'Main' as 'EditViewController'.") }
      }
